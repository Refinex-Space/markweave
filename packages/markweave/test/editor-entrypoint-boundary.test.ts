...
describe("editor entrypoint boundary", () => {
  it("keeps npm publishing metadata explicit for every publishable package", () => {
    ...
    for (const item of packages) {
      ...
      expect(packageJson.version).toBe("0.7.6");
  ...
  it("exports framework-neutral root APIs plus legacy adapter shims", async () => {
    ...
    expect(indexSource).toContain("MarkweaveUploadRequest");
    expect(indexSource).toContain("MarkweaveUploadResult");
    expect(indexSource).toContain("MarkweaveSlashCommandUploadHandler");
    expect(indexSource).toContain("MarkweaveAttachmentRef");
    expect(indexSource).toContain("MarkweaveAttachmentDownloadHandler");
    expect(indexSource).toContain("attrsFromMarkweaveAttachmentUploadResult");
    expect(indexSource).toContain("activateMarkweaveAttachmentDownload");
    ...
    expect(reactIndexSource).toContain("MarkweaveAttachmentRef");
    expect(reactIndexSource).toContain("MarkweaveAttachmentDownloadHandler");
    ...
    expect(vue2IndexSource).toContain("MarkweaveAttachmentRef");
    expect(vue2IndexSource).toContain("MarkweaveAttachmentDownloadHandler");
