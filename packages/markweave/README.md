...
Since 0.3.5, fixed outline positioning no longer depends on CSS query containers, and resolver-backed images enter a pending placeholder before a post-mount viewport probe. The shared behavior covers Electron 21 / Chromium 106 and current browsers across every adapter.
