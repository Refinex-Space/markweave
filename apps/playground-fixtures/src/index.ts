export const initialPlaygroundDocument = [
  ...
  ":::details{open} 折叠块",
  "",
  "折叠标题始终可见。点击箭头可以收起或展开正文，正文里可以继续放标注、列表和代码。",
  "",
  ":::info",
  "",
  "**Info:** Slash `/details` or `/折叠` inserts this collapsible block.",
  "",
  ":::",
  "",
  ":::",
  ...
  "",
  "Try `/image`, `/video`, `/table`, `/mermaid`, `/callout`, `/details`, and `/task` in a fresh paragraph. Attachment is intentionally disabled in the slash menu for now.",
  "",
